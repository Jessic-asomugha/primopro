            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-xs text-brand-muted leading-relaxed">
                  For bulk liquid hydrocarbon supply logs, LNG maritime bookings, or safety emergency dispatches, please utilize the phone or physical address coordinate logs.
                </p>
              </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="Bulk hydrocarbon distribution contract query..."
                        className="w-full rounded-lg bg-white border border-gray-200 px-3.5 py-2.5 text-xs text-brand-dark focus:outline-hidden focus:border-brand-accent transition"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Detail your industrial requirements or request further safety auditing logs..."
