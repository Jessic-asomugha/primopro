  ...
  const industries = [
    {
      ...
      avatarUrl: '/assets/.aistudio/oil-and-gas.jpg'
    },
    {
      name: 'Construction',
      ...
      avatarUrl: '/assets/.aistudio/construction.jpg'
    },
    {
      name: 'Manufacturing',
      ...
      avatarUrl: '/assets/.aistudio/manufacturing.jpg'
    },
    {
      name: 'Healthcare',
      ...
      avatarUrl: '/assets/.aistudio/national-cancer-institute-L8tWZT4CcVQ-unsplash.jpg'
    }
  ];
    ...
    <div className="bg-white text-brand-dark min-h-screen">
      ...
      <section className="relative py-24 bg-brand-dark text-white overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          <img 
            src="/assets/.aistudio/hero-imge.jpg" 
