...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  return (
    <div className="bg-white text-bark min-h-screen">
      
      {/* 1. Page Header Block */}
      <section className="bg-brand-light border-b border-gray-100 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl space-y-4">
            <h1 className="font-display text-4xl sm:text-5xl font-bold tracking-tight text-bark">Contact</h1>
              ...
              <div className="space-y-5 pt-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-bark font-medium mt-1">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-bark font-mono font-medium mt-1">
                ...
                {!submitted ? (
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-[10px] font-bold text-bark/70 uppercase tracking-wider mb-1.5">
                        ...
                        <input
                          ...
                          placeholder="John"
                          className="w-full  bg-white border border-gray-200 px-3.5 py-2.5 text-xs text-bark focus:outline-hidden focus:border-brand-accent transition"
                        />
                      </div>
                      <div>
                        <label className="block text-[10px] font-bold text-bark/70 uppercase tracking-wider mb-1.5">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full  bg-white border border-gray-200 px-3.5 py-2.5 text-xs text-bark focus:outline-hidden focus:border-brand-accent transition resize-none"
                      />
                    </div>
                  ...
                  >
                    ...
                    <button
                      onClick={resetForm}
                      className="bg-bark hover:bg-black text-white px-5 py-2  text-xs font-semibold transition"
                    >
      ...
      <section className="relative h-96 bg-bark overflow-hidden border-t border-gray-100">
        <div className="absolute inset-0 z-10 bg-bark/20" />
        <img 
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center p-4">
          <div className="bg-bark/95 border border-white/10  p-5 max-w-xs text-white">
